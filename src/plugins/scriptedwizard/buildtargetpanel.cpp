 ...
 *
 * $Revision: 8543 $
 * $Id: buildtargetpanel.cpp 8543 2012-11-10 22:36:18Z thomasdenk $
 * $HeadURL: svn://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/scriptedwizard/buildtargetpanel.cpp $
 */
